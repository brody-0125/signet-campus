...
data class AchievementSummary(val id: UUID, val name: String, val criteria: String, val version: Long = 0, val published: Boolean = false, val archived: Boolean = false, val predecessorId: UUID? = null)
